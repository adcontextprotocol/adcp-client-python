...
def generate_consolidated_exports() -> str:
    ...
    rebuild_lines = [
        ...
        "",
        "# Rebuild types that reference FormatId discriminated unions",
        "Product.model_rebuild()",
        "Format.model_rebuild()",
        "CreativeAsset.model_rebuild()",
        ...
        "ListCreativeFormatsResponse.model_rebuild()",
        "PreviewCreativeResponse.model_rebuild()",
        "PreviewCreativeResponse1.model_rebuild()",
        "PreviewCreativeResponse2.model_rebuild()",
        "CreateMediaBuyResponse.model_rebuild()",
        "CreateMediaBuyResponse1.model_rebuild()",
        "CreateMediaBuyResponse2.model_rebuild()",
        "BuildCreativeResponse.model_rebuild()",
        "BuildCreativeResponse1.model_rebuild()",
        "BuildCreativeResponse2.model_rebuild()",
        "SyncCreativesResponse.model_rebuild()",
        "SyncCreativesResponse1.model_rebuild()",
        "SyncCreativesResponse2.model_rebuild()",
        "UpdateMediaBuyResponse.model_rebuild()",
        "UpdateMediaBuyResponse1.model_rebuild()",
        "UpdateMediaBuyResponse2.model_rebuild()",
        "",
    ]
