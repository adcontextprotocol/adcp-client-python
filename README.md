...
The SDK 8 beta line is built against **AdCP 3.2.0-beta.9**, makes canonical
...
adcp.get_adcp_sdk_version()   # SDK package version, e.g. "8.0.0b10"
adcp.get_adcp_spec_version()  # AdCP spec this build targets, e.g. "3.2.0-beta.9"
```
