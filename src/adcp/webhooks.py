...
_TASK_TYPE_TO_PROTOCOL: dict[TaskType, AdcpProtocol] = {
    ...
    TaskType.sync_reporting_status: AdcpProtocol.media_buy,
    ...
    *,
    ...
    Args:
        ...
        operation_id: Client-generated identifier supplied through the
            registration's ``push_notification_config.operation_id``. Required
            for every task webhook; publishers echo it verbatim and MUST NOT
            derive it from the receiver URL.
