...
Generation date: 1763234995.456154
"""
...
from adcp.types.generated_poc.cpv_option import CpvPricingOption, Parameters, ViewThreshold, ViewThreshold1
...
from adcp.types.generated_poc.flat_rate_option import FlatRatePricingOption, Parameters
from adcp.types.generated_poc.format import Asset, AssetType, AssetsRequired, AssetsRequired1, Dimensions, Format, FormatCard, FormatCardDetailed, Render, Responsive, Type, Unit
...
from adcp.types.generated_poc.get_signals_request import CatalogType, Country, DeliverTo, Filters, GetSignalsRequest
...
from adcp.types.generated_poc.list_authorized_properties_response import ListAuthorizedPropertiesResponse, PrimaryCountry, PublisherDomain
from adcp.types.generated_poc.list_creative_formats_request import AssetType, ListCreativeFormatsRequest, Type
from adcp.types.generated_poc.list_creative_formats_response import Capability, CreativeAgent, ListCreativeFormatsResponse
from adcp.types.generated_poc.list_creatives_request import Direction, Field1, FieldModel, Filters, ListCreativesRequest, Pagination, Sort
from adcp.types.generated_poc.list_creatives_response import AssignedPackage, Assignments, Creative, Direction, ListCreativesResponse, Pagination, Performance, QuerySummary, SortApplied, Status, StatusSummary
...
from adcp.types.generated_poc.performance_feedback import FeedbackSource, MeasurementPeriod, MetricType, PerformanceFeedback, Status
from adcp.types.generated_poc.placement import Placement
from adcp.types.generated_poc.preview_creative_request import Input, Input2, OutputFormat, PreviewCreativeRequest, PreviewCreativeRequest1, PreviewCreativeRequest2, Request
from adcp.types.generated_poc.preview_creative_response import Error, Input, Input4, Preview, Preview1, Preview2, PreviewCreativeResponse, PreviewCreativeResponse1, PreviewCreativeResponse2, Response, Response1, Results, Results1
from adcp.types.generated_poc.preview_render import Dimensions, Embedding, PreviewRender, PreviewRender1, PreviewRender2, PreviewRender3
from adcp.types.generated_poc.pricing_model import PricingModel
from adcp.types.generated_poc.pricing_option import CpcOption, CpcvOption, CpmAuctionOption, CpmFixedOption, CppOption, CpvOption, FlatRateOption, Parameters, Parameters1, Parameters2, PriceGuidance, PriceGuidance1, PricingOption, VcpmAuctionOption, VcpmFixedOption, ViewThreshold, ViewThreshold1
from adcp.types.generated_poc.product import DeliveryMeasurement, Product, ProductCard, ProductCardDetailed, PropertyId, PropertyTag, PublisherProperty
...
from adcp.types.generated_poc.provide_performance_feedback_request import FeedbackSource, MeasurementPeriod, MetricType, ProvidePerformanceFeedbackRequest
...
from adcp.types.generated_poc.sync_creatives_response import Action, Creative, SyncCreativesResponse, SyncCreativesResponse1, SyncCreativesResponse2
...
from adcp.types.generated_poc.tasks_get_response import Details, Domain, Error, HistoryItem, Progress, TasksGetResponse, Type
from adcp.types.generated_poc.tasks_list_request import Direction, Domain, Field1, Filters, Pagination, Sort, TasksListRequest
from adcp.types.generated_poc.tasks_list_response import Direction, Domain, DomainBreakdown, Pagination, QuerySummary, SortApplied, Task, TasksListResponse
...
from adcp.types.generated_poc.vast_asset import TrackingEvent, VastAsset1, VastAsset2, VastVersion
from adcp.types.generated_poc.vcpm_auction_option import PriceGuidance, VcpmAuctionPricingOption
