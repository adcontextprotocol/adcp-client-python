...
#   timestamp: 2025-11-15T17:40:59+00:00
...
class Input1(AdCPBaseModel):
    ...
    macros: dict[str, str] | None = Field(None, description='Macro values to use for this preview')
    context_description: str | None = Field(
...
class PreviewCreativeRequest1(AdCPBaseModel):
    ...
    request_type: Literal['single'] = Field(
...
class Request(AdCPBaseModel):
    ...
    inputs: list[Input1] | None = Field(
        None, description='Array of input sets for generating multiple preview variants'
    )
    template_id: str | None = Field(
        None, description='Specific template ID for custom format rendering'
    )
...
class PreviewCreativeRequest2(AdCPBaseModel):
    ...
    request_type: Literal['batch'] = Field(
...
class PreviewCreativeRequest(RootModel[PreviewCreativeRequest1 | PreviewCreativeRequest2]):
    root: PreviewCreativeRequest1 | PreviewCreativeRequest2 = Field(
        ...,
