...
from ..enums import asset_content_type, disclosure_position, format_category
...
class ListCreativeFormatsRequest(AdCPBaseModel):
    ...
    disclosure_positions: Annotated[
        ...
        Field(
            description="Filter to formats whose supported_disclosure_positions include all of these positions. Use to find formats compatible with a brief's compliance requirements.",
            min_length=1,
        ),
    ] = None
