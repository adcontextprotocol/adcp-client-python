...
class MediaBuy(AdCPBaseModel):
    ...
    confirmed_at: Annotated[
        ...
        Field(
            description=(
                ...
                "timestamp; once set it remains stable across pause, resume, "
                "budget, and package updates. Pending/manual approval flows "
                "may leave it null until seller commitment happens."
            )
        ),
    ] = None
    cancellation: Annotated[
    ...
    revision: Annotated[
        ...
        Field(
            description=(
                "Current optimistic-concurrency revision for this media buy. "
                "Pass this value in update_media_buy; reload and retry if the "
                "seller reports a stale revision conflict."
            ),
            ge=1,
        ),
    ] = None
