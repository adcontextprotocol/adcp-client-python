...
from ..core import canonical_product, canonical_proposal
...
class Results6(RootModel[Results7 | Results8 | Results9 | Results10]):
    root: Annotated[Results7 | Results8 | Results9 | Results10, Field(discriminator='outcome')]
...
class Results12(RootModel[Results13 | Results14 | Results15 | Results10]):
    root: Annotated[Results13 | Results14 | Results15 | Results10, Field(discriminator='outcome')]
    def __getattr__(self, name: str) -> Any:
        """Proxy attribute access to the wrapped type."""
        if name.startswith('_'):
            raise AttributeError(name)
