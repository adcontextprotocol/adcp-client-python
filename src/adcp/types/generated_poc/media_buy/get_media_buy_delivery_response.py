...
from ..core import (
    ...
    catalog_item_delivery_metrics,
    collection_delivery_metrics,
    collection_property_delivery_metrics,
)
from ..core import context as context_1
from ..core import (
    creative_delivery_metrics,
    delivery_metric_aggregate,
    delivery_metrics,
...
from ..core import (
    geo_delivery_metrics,
    installment_delivery_metrics,
    installment_property_delivery_metrics,
    keyword_delivery_metrics,
    missing_metric,
    package_delivery_metric_value,
    pagination_response,
    placement_delivery_metrics,
    placement_property_delivery_metrics,
    property_delivery_metrics,
    reporting_control_total,
)
from ..core import reporting_revision as reporting_revision_1
...
from ..enums import reach_aggregation as reach_aggregation_1
from ..enums import reach_unit as reach_unit_1
from ..enums import sort_direction, sort_metric
...
class ReportingPeriod(AdCPBaseModel):
    ...
    start: Annotated[
        ...
        AwareDatetime,
        Field(
            description='Exclusive ISO 8601 end timestamp in UTC (e.g., 2024-02-06T00:00:00Z for a report covering 2024-02-05)'
        ),
    ]
...
class MediaBuyDelivery(AdCPBaseModel):
    ...
    daily_breakdown: Annotated[
        ...
        Field(
            description='Day-by-day delivery for a media-buy row with one currency. Sellers MUST omit this aggregate breakdown for a legacy or externally created mixed-currency buy because these rows have no package currency field.'
        ),
    ] = None
