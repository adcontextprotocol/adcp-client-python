...
class GetReportingStatusRequest(AdcpVersionEnvelope):
    ...
    changes_after: Annotated[
        str | None,
        Field(
            description='Periods-view incremental-repair checkpoint previously returned as changes_checkpoint after fully consuming a response. Returns newly committed obligations, revisions, adjustments, materializations, revision receipts, and adjustment receipts plus the current projection of each affected obligation. Omit for a full ledger read.',
            max_length=2048,
            min_length=1,
        ),
    ] = None
