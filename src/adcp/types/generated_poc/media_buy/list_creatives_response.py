...
from ..core import pagination_response, sub_asset
...
class QuerySummary(AdCPBaseModel):
    ...
    returned: Annotated[
        int | None, Field(description='Number of creatives returned in this response', ge=0)
    ] = None
...
class Creative(AdCPBaseModel):
    ...
    catalog: Annotated[
        catalog_1.Catalog | None, Field(description='Catalog referenced by this creative, if any')
    ] = None
