...
class CreateMediaBuyRequest(AdCPBaseModel):
    ...
    account_id: Annotated[
        str,
        Field(
            description="Account to bill for this media buy. The seller maps the agent's brand + operator to an account during sync_accounts; the agent passes that account_id here."
        ),
    ]
