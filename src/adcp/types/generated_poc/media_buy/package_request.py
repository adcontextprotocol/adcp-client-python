...
from ..core import creative_assets, creative_assignment, duration
...
class Creative43(AdCPBaseModel):
    pass
...
class Creative41(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class Creative42(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    creative_id: Annotated[
...
class Creative44(Creative41, Creative43):
    pass


class Creative45(Creative42, Creative43):
    pass


class Creative(RootModel[Creative44 | Creative45]):
    root: Creative44 | Creative45
    def __getattr__(self, name: str) -> Any:
        """Proxy attribute access to the wrapped type."""
        if name.startswith('_'):
            raise AttributeError(name)
