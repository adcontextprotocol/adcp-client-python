...
class ProductResponseFields(RootModel[list[ProductResponseField]]):
    root: Annotated[
        ...
        Field(
            description='Canonical product fields a buyer requests from list_products. Required product_id and name fields are always returned. Legacy named-format fields remain available only through get_products.',
            min_length=1,
