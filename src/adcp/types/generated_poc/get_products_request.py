...
#   timestamp: 2025-11-15T17:40:30+00:00
...
class Filters(AdCPBaseModel):
    ...
    format_types: list[FormatType] | None = Field(None, description='Filter by format types')
    format_ids: list[FormatId] | None = Field(None, description='Filter by specific format IDs')
...
class GetProductsRequest(AdCPBaseModel):
    ...
    filters: Filters | None = Field(None, description='Structured filters for product discovery')
