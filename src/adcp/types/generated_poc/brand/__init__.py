...
from ..enums import asset_content_type, brand_agent_type
...
class ProductCatalog(AdCPBaseModel):
    ...
    feed_format: Annotated[
        feed_format_1.FeedFormat | None, Field(description='Format of the product feed')
    ] = None
...
class Brand(AdCPBaseModel):
    ...
    contact: Annotated[Contact7 | None, Field(description='Brand-level contact information')] = None
...
class BrandDiscovery(
    ...
    root: Annotated[
        ...
        Field(
            ...
            examples=[
                {
                    '$schema': '/schemas/3.1.0-rc.13/brand.json',
