...
from ..enums import asset_content_type, brand_agent_type, right_type, right_use, talent_role
...
class DataSubjectContestation2(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    url: Annotated[
...
class DataSubjectContestation3(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    url: Annotated[
...
class DataSubjectContestation(RootModel[DataSubjectContestation2 | DataSubjectContestation3]):
    root: Annotated[
        DataSubjectContestation2 | DataSubjectContestation3,
        Field(
...
class BrandDiscovery4(AdCPBaseModel):
    ...
    brand_agent: Annotated[BrandAgent, Field(deprecated=True)]
    contact: Contact | None = None
    data_subject_contestation: DataSubjectContestation | None = None
    last_updated: AwareDatetime | None = None
...
class BrandDiscovery5(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    field_schema: Annotated[str | None, Field(alias='$schema')] = None
...
class BrandDiscovery6(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    field_schema: Annotated[str | None, Field(alias='$schema')] = None
...
class BrandDiscovery(
    ...
    root: Annotated[
        ...
        Field(
            ...
            examples=[
                {
                    '$schema': '/schemas/3.1.0-beta.3/brand.json',
