...
class AdcpAgentsAuthorization2(AdCPBaseModel):
    ...
    signals: Annotated[
        ...
        Field(
            description="Signal catalog published by this domain. Each entry defines a signal id within this file's publishing-domain namespace; entries do not include signal_ref objects. Signals Protocol discovery and media-buy product targeting reference these through signal_ref scope 'data_provider', with data_provider_domain set to this file's publishing domain and signal_id set to signals[].id.",
            min_length=1,
        ),
    ] = None
    signal_tags: Annotated[
...
class AdcpAgentsAuthorization(RootModel[AdcpAgentsAuthorization1 | AdcpAgentsAuthorization2]):
    root: Annotated[
        ...
        Field(
            ...
            examples=[
                {
                    '$schema': '/schemas/3.1.0-beta.5/adagents.json',
