...
class AuthorizedAgents8(AuthorizedAgents1):
    authorization_type: Literal['property_ids'] = 'property_ids'


class AuthorizedAgents9(AuthorizedAgents2):
    authorization_type: Literal['property_tags'] = 'property_tags'


class AuthorizedAgents11(AuthorizedAgents4):
    authorization_type: Literal['publisher_properties'] = 'publisher_properties'


class AuthorizedAgents12(AuthorizedAgents5):
    authorization_type: Literal['signal_ids'] = 'signal_ids'


class AuthorizedAgents13(AuthorizedAgents6):
    authorization_type: Literal['signal_tags'] = 'signal_tags'


class AuthorizedAgents15(AuthorizedAgents1):
    authorization_type: Literal['property_ids'] = 'property_ids'


class AuthorizedAgents16(AuthorizedAgents2):
    authorization_type: Literal['property_tags'] = 'property_tags'


class AuthorizedAgents18(AuthorizedAgents4):
    authorization_type: Literal['publisher_properties'] = 'publisher_properties'


class AuthorizedAgents19(AuthorizedAgents5):
    authorization_type: Literal['signal_ids'] = 'signal_ids'


class AuthorizedAgents20(AuthorizedAgents6):
    authorization_type: Literal['signal_tags'] = 'signal_tags'


class AuthorizedAgents22(AuthorizedAgents1):
    authorization_type: Literal['property_ids'] = 'property_ids'


class AuthorizedAgents23(AuthorizedAgents2):
    authorization_type: Literal['property_tags'] = 'property_tags'


class AuthorizedAgents25(AuthorizedAgents4):
    authorization_type: Literal['publisher_properties'] = 'publisher_properties'


class AuthorizedAgents26(AuthorizedAgents5):
    authorization_type: Literal['signal_ids'] = 'signal_ids'


class AuthorizedAgents27(AuthorizedAgents6):
    authorization_type: Literal['signal_tags'] = 'signal_tags'


class AuthorizedAgents29(AuthorizedAgents1):
    authorization_type: Literal['property_ids'] = 'property_ids'


class AuthorizedAgents30(AuthorizedAgents2):
    authorization_type: Literal['property_tags'] = 'property_tags'


class AuthorizedAgents32(AuthorizedAgents4):
    authorization_type: Literal['publisher_properties'] = 'publisher_properties'


class AuthorizedAgents33(AuthorizedAgents5):
    authorization_type: Literal['signal_ids'] = 'signal_ids'


class AuthorizedAgents34(AuthorizedAgents6):
    authorization_type: Literal['signal_tags'] = 'signal_tags'


class AuthorizedAgents36(AuthorizedAgents1):
    authorization_type: Literal['property_ids'] = 'property_ids'


class AuthorizedAgents37(AuthorizedAgents2):
    authorization_type: Literal['property_tags'] = 'property_tags'


class AuthorizedAgents39(AuthorizedAgents4):
    authorization_type: Literal['publisher_properties'] = 'publisher_properties'


class AuthorizedAgents40(AuthorizedAgents5):
    authorization_type: Literal['signal_ids'] = 'signal_ids'


class AuthorizedAgents41(AuthorizedAgents6):
    authorization_type: Literal['signal_tags'] = 'signal_tags'


class AuthorizedAgents43(AuthorizedAgents1):
    authorization_type: Literal['property_ids'] = 'property_ids'


class AuthorizedAgents44(AuthorizedAgents2):
    authorization_type: Literal['property_tags'] = 'property_tags'


class AuthorizedAgents46(AuthorizedAgents4):
    authorization_type: Literal['publisher_properties'] = 'publisher_properties'


class AuthorizedAgents47(AuthorizedAgents5):
    authorization_type: Literal['signal_ids'] = 'signal_ids'


class AuthorizedAgents48(AuthorizedAgents6):
    authorization_type: Literal['signal_tags'] = 'signal_tags'
...
class AuthorizedAgents10(AuthorizedAgents3):
    authorization_type: Literal['inline_properties'] = 'inline_properties'


AuthorizedAgents7 = AuthorizedAgents


class AuthorizedAgents17(AuthorizedAgents3):
    authorization_type: Literal['inline_properties'] = 'inline_properties'
...
class AuthorizedAgents24(AuthorizedAgents3):
    authorization_type: Literal['inline_properties'] = 'inline_properties'
...
class AuthorizedAgents31(AuthorizedAgents3):
    authorization_type: Literal['inline_properties'] = 'inline_properties'
...
class AuthorizedAgents38(AuthorizedAgents3):
    authorization_type: Literal['inline_properties'] = 'inline_properties'
...
class AuthorizedAgents45(AuthorizedAgents3):
    authorization_type: Literal['inline_properties'] = 'inline_properties'
...
class AdcpAgentsAuthorization210(AdcpAgentsAuthorization27):
    ...
    properties: Annotated[list[property.Property], Field(description='Array of all properties covered by this adagents.json file. Defines the canonical property list that authorized agents reference.', min_length=1), Field(min_length=1)]
...
class AdcpAgentsAuthorization211(AdcpAgentsAuthorization27):
    ...
    placements: Annotated[list[placement_definition.PlacementDefinition], Field(description='Canonical placement definitions for properties in this file. Products SHOULD reuse these placement_id values when exposing inventory in get_products, and authorized agents can scope authorization to these placement IDs.', min_length=1), Field(min_length=1)]
...
class AdcpAgentsAuthorization212(AdcpAgentsAuthorization27):
    ...
    collections: Annotated[list[collection.Collection], Field(description='Collections produced or distributed by this publisher. Declares the content programs whose inventory is sold through authorized agents. Products in get_products responses reference these collections by collection_id.'), Field(min_length=1)]
...
class AdcpAgentsAuthorization213(AdcpAgentsAuthorization27):
    ...
    signals: Annotated[list[signal_definition.SignalDefinition], Field(description="Signal definitions published by this domain. Each entry defines a signal id within this file's publishing-domain namespace; entries do not include signal_ref objects. Signals Protocol discovery and media-buy product targeting reference these through signal_ref scope 'data_provider', with data_provider_domain set to this file's publishing domain and signal_id set to signals[].id.", min_length=1), Field(min_length=1)]
...
class AdcpAgentsAuthorization2(
    ...
    root: Annotated[
        ...
        Field(
            ...
            examples=[
                {
                    '$schema': 'https://adcontextprotocol.org/schemas/3.2.0-rc.6/adagents.json',
