...
class AdcpAgentsAuthorization28(AdcpAgentsAuthorization21, AdcpAgentsAuthorization27):
    model_config = ConfigDict(
        extra='allow',
    )
    field_schema: Annotated[
...
class AdcpAgentsAuthorization210(AdcpAgentsAuthorization23, AdcpAgentsAuthorization27):
    model_config = ConfigDict(
        extra='allow',
    )
    field_schema: Annotated[
...
class AdcpAgentsAuthorization211(AdcpAgentsAuthorization24, AdcpAgentsAuthorization27):
    model_config = ConfigDict(
        extra='allow',
    )
    field_schema: Annotated[
...
class AdcpAgentsAuthorization212(AdcpAgentsAuthorization25, AdcpAgentsAuthorization27):
    model_config = ConfigDict(
        extra='allow',
    )
    field_schema: Annotated[
...
class AdcpAgentsAuthorization213(AdcpAgentsAuthorization26, AdcpAgentsAuthorization27):
    model_config = ConfigDict(
        extra='allow',
    )
    field_schema: Annotated[
...
class AdcpAgentsAuthorization2(
    ...
    root: Annotated[
        ...
        Field(
            ...
            examples=[
                {
                    '$schema': '/schemas/3.1.0-rc.9/adagents.json',
