...
class PublisherProperties(AdCPBaseModel):
    ...
    publisher_domain: Annotated[
        str,
        Field(
            description="Domain where the publisher's json is hosted (e.g., 'cnn.com')",
            pattern='^[a-z0-9]([a-z0-9-]*[a-z0-9])?(\\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$',
        ),
    ]
    ...
    property_ids: Annotated[
        list[PropertyId],
        Field(
            description="Specific property IDs from the publisher's json properties array",
            min_length=1,
        ),
    ]
...
class PublisherProperties1(AdCPBaseModel):
    ...
    property_tags: Annotated[
        list[PropertyTag],
        Field(
            description="Property tags from the publisher's json tags. Agent is authorized for all properties with these tags",
            min_length=1,
        ),
    ]
...
class AuthorizedSalesAgents(AdCPBaseModel):
    ...
    field_schema: Annotated[
        str | None,
        Field(alias='$schema', description='JSON Schema identifier for this json file'),
    ] = 'https://adcontextprotocol.org/schemas/v1/json'
    contact: Annotated[
        Contact | None,
        Field(
            description='Contact information for the entity managing this json file (may be publisher or third-party operator)'
        ),
    ] = None
    properties: Annotated[
        list[property.Property] | None,
        Field(
            description='Array of all properties covered by this json file. Same structure as list_authorized_properties response.',
            min_length=1,
        ),
    ] = None
    tags: Annotated[
