...
class TargetFrequency5(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    min: Annotated[
...
class OptimizationGoal2(AdCPBaseModel):
    ...
    target: Annotated[
        Target12 | Target13 | Target14 | None,
        Field(
...
class OptimizationGoal1(AdCPBaseModel):
    ...
    target_frequency: Annotated[
        TargetFrequency | TargetFrequency5 | None,
        Field(
