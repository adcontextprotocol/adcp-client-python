...
class TargetFrequency(AdCPBaseModel):
    ...
    window: Annotated[
        str,
        Field(
            description="Time window over which frequency is measured (e.g., '1d', '7d', '30d', 'campaign'). 'campaign' applies the target across the full campaign flight — appropriate for short-burst or awareness campaigns. Weekly windows ('7d') are typical for brand campaigns; daily windows ('1d') suit high-cadence direct response."
        ),
    ]
