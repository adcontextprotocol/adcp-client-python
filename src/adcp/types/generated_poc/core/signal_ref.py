...
class SignalRef7(AdCPBaseModel):
...
class SignalRef8(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    scope: Annotated[
...
class SignalRef9(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    scope: Annotated[
...
class SignalRef(RootModel[SignalRef7 | SignalRef8 | SignalRef9]):
    root: Annotated[
        SignalRef7 | SignalRef8 | SignalRef9,
        Field(
