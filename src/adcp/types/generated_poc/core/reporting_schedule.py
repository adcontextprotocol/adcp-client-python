...
class ReportingSchedule(AdCPBaseModel):
    ...
    period_timezone: Annotated[
        str | None,
        Field(
            description='Required IANA timezone for billing_cycle calendar arithmetic. A numeric UTC offset is not sufficient because it does not define DST transitions.',
            max_length=255,
            min_length=1,
        ),
    ] = None
