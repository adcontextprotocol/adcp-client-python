...
from ..enums import action_source, audio_distribution_type, catalog_type
...
from . import audience_activation_method
from . import audience_evidence as audience_evidence_1
from . import audience_evidence_selection, brand_ref
...
from . import data_provider_signal_selector, delivery_forecast, demographic_targeting_capability
from . import ext as ext_1
from . import format_id, installment, inventory_list_application
from . import measurement_readiness as measurement_readiness_1
from . import measurement_terms as measurement_terms_1
from . import media_buy_support as media_buy_support_1
...
class PublisherProperty(RootModel[PublisherProperty85 | PublisherProperty86 | PublisherProperty87]):
