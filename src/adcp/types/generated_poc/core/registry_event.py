...
from ..enums import adcp_protocol, collection_kind, distribution_identifier_type
from . import agent_signing_key
from . import collection as collection_1
from . import collection_selector, format_id, identifier
...
class PublisherAdagentsPayload(AdCPBaseModel):
    ...
    collection_count: Annotated[int | None, Field(ge=0)] = None
...
class Payload10(PublisherAdagentsPayload):
    pass
