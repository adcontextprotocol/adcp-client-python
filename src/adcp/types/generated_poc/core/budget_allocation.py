...
#   filename:  core/budget_allocation.json
...
class OptimizationGoal(RootModel[OptimizationGoal5 | OptimizationGoal6 | OptimizationGoal7]):
    root: OptimizationGoal5 | OptimizationGoal6 | OptimizationGoal7
...
class BudgetAllocation(RootModel[BudgetAllocation1 | BudgetAllocation2]):
    root: Annotated[
        BudgetAllocation1 | BudgetAllocation2,
        Field(
