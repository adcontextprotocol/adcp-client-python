...
from . import canonical_pricing_option
from . import canonical_product as canonical_product_1
...
class Payload(AdCPBaseModel):
    ...
    canonical_pricing_options: Annotated[
        list[canonical_pricing_option.CanonicalPricingOption] | None,
        Field(
            description='Full post-change canonical pricing array for list_products mirrors.',
            min_length=1,
        ),
    ] = None
