...
class Geometry20(Geometry):
    pass


class Geometry21(Geometry):
    pass
...
class GeoProximity21(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    lat: Annotated[
...
class GeoProximity22(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    lat: Annotated[
...
class TargetingOverlay(AdCPBaseModel):
    ...
    geo_proximity: Annotated[
        list[GeoProximity | GeoProximity21 | GeoProximity22] | None,
        Field(
