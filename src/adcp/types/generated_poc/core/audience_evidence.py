...
class Subject82(Subject2):
    pass


class Subject83(Subject3):
    pass


class Subject84(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    type: Literal['resource'] = 'resource'
...
class Subject86(Subject82):
    model_config = ConfigDict(
        extra='forbid',
    )


class Subject87(Subject83):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class Subject92(Subject2):
    pass


class Subject93(Subject3):
    pass


class Subject94(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    type: Literal['resource'] = 'resource'
...
class Subject97(Subject93):
    model_config = ConfigDict(
        extra='forbid',
    )


class Subject1(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class Subject5(Subject1):
    model_config = ConfigDict(
        extra='forbid',
    )


class Subject6(Subject2):
    model_config = ConfigDict(
        extra='forbid',
    )
    brand: brand_ref.BrandReference
...
class Subject(RootModel[Subject5 | Subject6 | Subject7]):
    root: Annotated[
...
class Subject81(Subject1):
    pass


class Subject85(Subject81):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class Subject8(RootModel[Subject85 | Subject86 | Subject87]):
    root: Annotated[
        Subject85 | Subject86 | Subject87,
        Field(
            description='Typed identity of the entity or object an attestation credential is about. Brand and agent subjects reuse canonical AdCP identities. Other resources use an open, URI-namespaced resource_type plus an identifier whose namespace is explicit. Evaluators MUST compare the resolved credential subject to this complete typed identity, not to id alone.',
            discriminator='type',
            examples=[
...
class Subject91(Subject1):
    pass


class Subject95(Subject91):
    model_config = ConfigDict(
        extra='forbid',
    )
    resource_type: Annotated[
...
class Subject9(RootModel[Subject95 | Subject96 | Subject97]):
    root: Annotated[
        Subject95 | Subject96 | Subject97,
        Field(
            description='Typed identity of the entity or object an attestation credential is about. Brand and agent subjects reuse canonical AdCP identities. Other resources use an open, URI-namespaced resource_type plus an identifier whose namespace is explicit. Evaluators MUST compare the resolved credential subject to this complete typed identity, not to id alone.',
            discriminator='type',
            examples=[
