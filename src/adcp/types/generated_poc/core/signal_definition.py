...
class SeedSource(AdCPBaseModel):
    ...
    provider_signed: Annotated[
        bool,
        Field(
            description="Whether the seed source carries a signed attestation under one of the provider's published signing keys."
        ),
    ]
...
class DataSubjectRights(AdCPBaseModel):
    ...
    channels: Annotated[
        list[Channel],
        Field(
            description='Rights request channels and the rights each channel supports.',
            min_length=1,
        ),
    ]
    response_sla_days: Annotated[
        int | None,
        Field(
            description='Maximum response time in days for the declared rights channels.',
            ge=1,
            le=90,
        ),
    ] = None
    gpc_honored: Annotated[
        bool | None,
        Field(
            description='Whether Global Privacy Control signals are honored as objection or opt-out requests for this signal.'
        ),
    ] = None
...
class SignalDefinition(AdCPBaseModel):
    ...
    subject_type: Annotated[
        SubjectType | None, Field(description='What kind of subject this signal characterizes.')
    ] = None
    resolution_method: Annotated[
        ResolutionMethod | None, Field(description='How the subject is resolved at decision time.')
    ] = None
    id_types: Annotated[
        list[IdType] | None,
        Field(
    ...
    countries: Annotated[
        list[Country] | None,
        Field(
            description='ISO 3166-1 alpha-2 country codes where the signal is applicable. Sellers must not expose a signal for media buys in countries outside this list unless their own policy allows a narrower operational override.',
            min_length=1,
        ),
    ] = None
    ...
    data_subject_rights: Annotated[
        ...
        Field(
            description='Per-signal data-subject-rights routing. Inline on the signal because upstream source and rights routing can differ by segment even when the publishing domain is the same. This is a contact/routing reference, not a machine-callable AdCP API.'
        ),
    ] = None
