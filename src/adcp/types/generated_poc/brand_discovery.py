...
#   timestamp: 2026-09-02T17:01:47+00:00
...
class LocalizedStringListEntry(RootModel[dict[str, list[str]]]):
    root: Annotated[dict[str, list[str]], Field(min_length=1)]
...
class BrandDiscovery(
    ...
    root: Annotated[
        ...
        Field(
            ...
            examples=[
                {
                    '$schema': 'https://adcontextprotocol.org/schemas/3.2.0-beta.11/brand.json',
