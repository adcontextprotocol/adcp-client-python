...
class Transitions19(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    transition_id: Annotated[
...
class Transitions20(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    transition_id: Annotated[
...
class TransitionMode21(StrEnum):
    instant = 'instant'
    animated = 'animated'
    scroll_linked = 'scroll_linked'


class Transitions21(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    transition_id: Annotated[
...
class Transitions22(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    transition_id: Annotated[
...
class Transitions23(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    transition_id: Annotated[
