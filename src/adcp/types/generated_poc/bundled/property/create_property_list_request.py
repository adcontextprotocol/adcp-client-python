...
class DataSubjectContestation25(AdCPBaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class Brand(AdCPBaseModel):
    ...
    data_subject_contestation: Annotated[
        DataSubjectContestation | DataSubjectContestation25 | None,
        Field(
...
class DataSubjectContestation27(DataSubjectContestation25):
    pass


class Brand8(AdCPBaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    domain: Annotated[
