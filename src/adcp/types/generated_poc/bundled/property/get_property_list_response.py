...
class DataSubjectContestation59(AdCPBaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class Brand(AdCPBaseModel):
    ...
    data_subject_contestation: Annotated[
        DataSubjectContestation | DataSubjectContestation59 | None,
        Field(
...
class DataSubjectContestation60(DataSubjectContestation):
    pass


class DataSubjectContestation61(DataSubjectContestation59):
    pass


class Brand24(AdCPBaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    domain: Annotated[
    ...
    data_subject_contestation: Annotated[
        DataSubjectContestation60 | DataSubjectContestation61 | None,
        Field(
            description="Inline override for the brand's contestation contact point. Useful when the operator does not control brand.json but needs to discharge Art 22(3) for this plan. brand.json is canonical; when omitted, governance agents resolve brand → house → missing."
        ),
    ] = None
