...
class DataSubjectContestation29(AdCPBaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class Brand(AdCPBaseModel):
    ...
    data_subject_contestation: Annotated[
        DataSubjectContestation | DataSubjectContestation29 | None,
        Field(
...
class DataSubjectContestation31(DataSubjectContestation29):
    pass


class Brand10(AdCPBaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    domain: Annotated[
