...
class VerifyAgent2475(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class DeclaredBy1244(DeclaredBy):
    pass
...
class VerifyAgent2477(VerifyAgent2475):
    pass
...
class Jurisdiction1295(Jurisdiction):
    pass
...
class BrandKitOverride155(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    logo: Annotated[
        Logo156 | None, Field(description='Override logo asset.', title='Image Asset')
    ] = None
    colors: Annotated[Colors | None, Field(description='Override brand colors (hex strings).')] = (
        None
    )
