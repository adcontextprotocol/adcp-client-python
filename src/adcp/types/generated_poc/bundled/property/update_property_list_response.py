...
class VerifyAgent1539(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class VerifyAgent1541(VerifyAgent1539):
    pass
...
class PricingOption211(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption212(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption213(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption214(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption215(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption216(AdCPBaseModel):
...
class PricingOption217(PricingOption211, PricingOption216):
    pass


class PricingOption218(PricingOption212, PricingOption216):
    pass


class PricingOption219(PricingOption213, PricingOption216):
    pass


class PricingOption2110(PricingOption214, PricingOption216):
    pass


class PricingOption2111(PricingOption215, PricingOption216):
    pass
...
class BrandKitOverride89(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    logo: Annotated[
        Logo90 | None, Field(description='Override logo asset.', title='Image Asset')
    ] = None
    colors: Annotated[Colors | None, Field(description='Override brand colors (hex strings).')] = (
        None
    )
