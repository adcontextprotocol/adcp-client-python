...
class VerifyAgent2479(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class DeclaredBy1246(DeclaredBy):
    pass
...
class VerifyAgent2481(VerifyAgent2479):
    pass
...
class Jurisdiction1297(Jurisdiction):
    pass
...
class BrandKitOverride157(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    logo: Annotated[
        Logo158 | None, Field(description='Override logo asset.', title='Image Asset')
    ] = None
    colors: Annotated[Colors | None, Field(description='Override brand colors (hex strings).')] = (
        None
    )
