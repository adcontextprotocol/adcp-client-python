...
class VerifyAgent2461(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class VerifyAgent2463(VerifyAgent2461):
    pass
...
class PricingOption281(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption282(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption283(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption284(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption285(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption286(AdCPBaseModel):
...
class PricingOption287(PricingOption281, PricingOption286):
    pass


class PricingOption288(PricingOption282, PricingOption286):
    pass


class PricingOption289(PricingOption283, PricingOption286):
    pass


class PricingOption2810(PricingOption284, PricingOption286):
    pass


class PricingOption2811(PricingOption285, PricingOption286):
    pass
...
class BrandKitOverride148(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    logo: Annotated[
        Logo149 | None, Field(description='Override logo asset.', title='Image Asset')
    ] = None
    colors: Annotated[Colors | None, Field(description='Override brand colors (hex strings).')] = (
        None
    )
