...
#   filename:  list_creative_formats_response.json
#   timestamp: 2026-06-04T19:45:59+00:00
...
class Requirements2(AdCPBaseModel):
    ...
    formats: Annotated[list[Format2] | None, Field(description='Accepted audio file formats')] = (
        None
    )
...
class AssetRequirements2(Requirements2):
    pass


class AssetRequirements3(Requirements3):
    pass


class AssetRequirements4(Requirements4):
    pass


class AssetRequirements5(Requirements5):
    pass


class AssetRequirements6(Requirements6):
    pass


class AssetRequirements7(Requirements7):
    pass


class AssetRequirements8(Requirements8):
    pass


class AssetRequirements9(Requirements9):
    pass


class AssetRequirements10(Requirements10):
    pass


class AssetRequirements11(Requirements11):
    pass
...
class PricingOption6(AdCPBaseModel):
...
class PricingOption7(PricingOption1, PricingOption6):
    pass


class PricingOption8(PricingOption2, PricingOption6):
    pass


class PricingOption9(PricingOption3, PricingOption6):
    pass


class PricingOption10(PricingOption4, PricingOption6):
    pass


class PricingOption11(PricingOption5, PricingOption6):
    pass


class PricingOption(
    RootModel[PricingOption7 | PricingOption8 | PricingOption9 | PricingOption10 | PricingOption11]
):
    root: Annotated[
        PricingOption7 | PricingOption8 | PricingOption9 | PricingOption10 | PricingOption11,
        Field(
...
class Requirements(AdCPBaseModel):
    ...
    formats: Annotated[list[Format1] | None, Field(description='Accepted image file formats')] = (
        None
    )
    min_dpi: Annotated[
        int | None,
...
class Assets1(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets2(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets3(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets4(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class AssetRequirements(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    min_width: Annotated[
...
class AssetRequirements1(Requirements1):
    pass
...
class Assets15(AdCPBaseModel):
    ...
    assets: Annotated[
        list[Assets16], Field(description='Assets within each repetition of this group')
    ]
...
class Params4(AdCPBaseModel):
    ...
    audio_codecs: list[AudioCodec3] | None = None
    containers: list[Container3] | None = None
...
class Params6(AdCPBaseModel):
    ...
    audio_codecs: list[AudioCodec4] | None = None
