...
#   filename:  bundled/media_buy/list_creative_formats_response.json
...
class Requirements2(AdCPBaseModel):
    ...
    formats: Annotated[list[Format7] | None, Field(description="Accepted audio file formats")] = (
        None
    )
...
class PricingOption161(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
...
class PricingOption162(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
...
class PricingOption163(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
...
class PricingOption164(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
...
class PricingOption165(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
...
class PricingOption166(AdCPBaseModel):
...
class PricingOption167(PricingOption161, PricingOption166):
    pass


class PricingOption168(PricingOption162, PricingOption166):
    pass


class PricingOption169(PricingOption163, PricingOption166):
    pass


class PricingOption1610(PricingOption164, PricingOption166):
    pass


class PricingOption1611(PricingOption165, PricingOption166):
    pass
...
class Assets160(BaseIndividualAsset):
    item_type: Literal["individual"] = "individual"
...
class Assets161(BaseIndividualAsset):
    item_type: Literal["individual"] = "individual"
...
class Assets162(BaseIndividualAsset):
    item_type: Literal["individual"] = "individual"
...
class Assets163(BaseIndividualAsset):
    item_type: Literal["individual"] = "individual"
...
class Assets164(BaseIndividualAsset):
    item_type: Literal["individual"] = "individual"
...
class Assets165(BaseIndividualAsset):
    item_type: Literal["individual"] = "individual"
...
class Assets166(BaseIndividualAsset):
    item_type: Literal["individual"] = "individual"
...
class Assets167(BaseIndividualAsset):
    item_type: Literal["individual"] = "individual"
...
class Assets168(BaseIndividualAsset):
    item_type: Literal["individual"] = "individual"
...
class Assets169(BaseIndividualAsset):
    item_type: Literal["individual"] = "individual"
...
class Assets170(BaseIndividualAsset):
    item_type: Literal["individual"] = "individual"
...
class Assets171(BaseIndividualAsset):
    item_type: Literal["individual"] = "individual"
...
class Assets172(BaseIndividualAsset):
    item_type: Literal["individual"] = "individual"
...
class Assets174(BaseGroupAsset):
    asset_type: Literal["image"] = "image"
    requirements: Annotated[
        Requirements13 | None,
        Field(
...
class Assets175(BaseGroupAsset):
    asset_type: Literal["video"] = "video"
    requirements: Annotated[
        Requirements14 | None,
        Field(
...
class Assets176(BaseGroupAsset):
    asset_type: Literal["audio"] = "audio"
    requirements: Annotated[
        Requirements15 | None,
        Field(
...
class Assets177(BaseGroupAsset):
    asset_type: Literal["text"] = "text"
    requirements: Annotated[
        Requirements16 | None,
        Field(
...
class Assets178(BaseGroupAsset):
    asset_type: Literal["markdown"] = "markdown"
    requirements: Annotated[
        Requirements17 | None,
        Field(
...
class Assets179(BaseGroupAsset):
    asset_type: Literal["html"] = "html"
    requirements: Annotated[
        Requirements18 | None,
        Field(
...
class Assets180(BaseGroupAsset):
    asset_type: Literal["css"] = "css"
    requirements: Annotated[
        Requirements19 | None,
        Field(description="Requirements for CSS creative assets.", title="CSS Asset Requirements"),
...
class Assets181(BaseGroupAsset):
    asset_type: Literal["javascript"] = "javascript"
    requirements: Annotated[
        Requirements20 | None,
        Field(
...
class Assets182(BaseGroupAsset):
    asset_type: Literal["vast"] = "vast"
    requirements: Annotated[
        Requirements21 | None,
        Field(
...
class Assets183(BaseGroupAsset):
    asset_type: Literal["daast"] = "daast"
    requirements: Annotated[
        Requirements22 | None,
        Field(
...
class Assets184(BaseGroupAsset):
    asset_type: Literal["url"] = "url"
    requirements: Annotated[
        Requirements23 | None,
        Field(
...
class Assets185(BaseGroupAsset):
    asset_type: Literal["webhook"] = "webhook"
    requirements: Annotated[
        Requirements24 | None,
        Field(
