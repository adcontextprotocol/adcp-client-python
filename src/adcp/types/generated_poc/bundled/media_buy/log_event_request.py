...
#   timestamp: 2026-05-22T13:16:37+00:00
...
class UserMatch1(AdCPBaseModel):
    ...
    uids: Annotated[
        list[Uid1] | None, Field(description='Universal ID values for user matching', min_length=1)
    ] = None
    hashed_email: Annotated[
        str,
        Field(
...
class Event(AdCPBaseModel):
    ...
    user_match: Annotated[
        UserMatch | UserMatch1 | UserMatch2 | UserMatch3 | UserMatch4 | None,
