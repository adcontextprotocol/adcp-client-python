...
#   timestamp: 2026-05-22T13:16:28+00:00
...
class GeoProximity1(AdCPBaseModel):
    ...
    travel_time: Annotated[
        TravelTime1 | None, Field(description='Travel time limit for isochrone calculation')
    ] = None
    transport_mode: Annotated[
        TransportMode | None,
        Field(
    ...
    radius: Annotated[Radius1, Field(description='Simple radius from the point')]
    geometry: Annotated[
        Geometry1 | None,
        Field(description='Pre-computed GeoJSON geometry defining the proximity boundary'),
    ] = None
...
class GeoProximity2(AdCPBaseModel):
    ...
    radius: Annotated[Radius2 | None, Field(description='Simple radius from the point')] = None
    geometry: Annotated[
        Geometry2,
        Field(description='Pre-computed GeoJSON geometry defining the proximity boundary'),
    ]
