...
#   filename:  bundled/media_buy/provide_performance_feedback_response.json
...
class ProvidePerformanceFeedbackResponse3(AdCPBaseModel):
...
class ProvidePerformanceFeedbackResponse4(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    errors: Annotated[
...
ProvidePerformanceFeedbackResponse = ProvidePerformanceFeedbackResponse3 | ProvidePerformanceFeedbackResponse4
