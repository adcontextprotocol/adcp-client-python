...
#   filename:  bundled/media_buy/sync_audiences_request.json
...
class DataSubjectContestation83(AdCPBaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class Brand(AdCPBaseModel):
    ...
    data_subject_contestation: Annotated[
        DataSubjectContestation | DataSubjectContestation83 | None,
        Field(
