...
#   filename:  bundled/media_buy/update_media_buy_response.json
...
class Adjustments23(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    kind: Annotated[
...
class PriceBreakdown(AdCPBaseModel):
    ...
    adjustments: Annotated[
        list[Adjustments | Adjustments23],
        Field(
...
class Suppress22(Suppress):
    pass


class Window33(Suppress):
    pass


class Suppress23(Suppress):
    pass


class Window34(Suppress):
    pass
...
class Radius(AdCPBaseModel):
    ...
    unit: Annotated[Unit116, Field(description="Distance unit.", title="Distance Unit")]
...
class Geometry(AdCPBaseModel):
    ...
    type: Annotated[Type76, Field(description="GeoJSON geometry type.")]
...
class TravelTime29(TravelTime):
    pass


class Radius29(Radius):
    pass


class Geometry29(Geometry):
    pass


class GeoProximity30(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    lat: Annotated[
...
class TravelTime30(TravelTime):
    pass


class Radius30(Radius):
    pass


class Geometry30(Geometry):
    pass


class GeoProximity31(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    lat: Annotated[
...
class DataSubjectContestation99(AdCPBaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class Vendor(AdCPBaseModel):
    ...
    data_subject_contestation: Annotated[
        DataSubjectContestation | DataSubjectContestation99 | None,
        Field(
...
class DataSubjectContestation100(DataSubjectContestation):
    pass


class DataSubjectContestation101(DataSubjectContestation99):
    pass
...
class Vendor12(AdCPBaseModel):
    ...
    data_subject_contestation: Annotated[
        DataSubjectContestation100 | DataSubjectContestation101 | None,
        Field(
            description="Inline override for the brand's contestation contact point. Useful when the operator does not control brand.json but needs to discharge Art 22(3) for this plan. brand.json is canonical; when omitted, governance agents resolve brand → house → missing."
        ),
    ] = None
...
class Window36(Suppress):
    pass


class TargetFrequency13(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    min: Annotated[
...
class UpdateMediaBuyResponse4(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    errors: Annotated[
...
class FrequencyCap22(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    suppress: Annotated[
...
class FrequencyCap23(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    suppress: Annotated[
...
class TargetingOverlay(AdCPBaseModel):
    ...
    frequency_cap: Annotated[
        FrequencyCap | FrequencyCap22 | FrequencyCap23 | None,
        Field(
    ...
    geo_proximity: Annotated[
        list[GeoProximity | GeoProximity30 | GeoProximity31] | None,
        Field(
...
class OptimizationGoals(AdCPBaseModel):
    ...
    target_frequency: Annotated[
        TargetFrequency | TargetFrequency13 | None,
        Field(
...
class OptimizationGoals11(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    ...
    target: Annotated[
        Target32 | Target33 | Target34 | None,
        Field(
...
class AffectedPackage(AdCPBaseModel):
    ...
    optimization_goals: Annotated[
        list[OptimizationGoals | OptimizationGoals11] | None,
        Field(
...
class UpdateMediaBuyResponse3(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
...
UpdateMediaBuyResponse = UpdateMediaBuyResponse3 | UpdateMediaBuyResponse4
