...
class VerifyAgent417(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class VerifyAgent419(VerifyAgent417):
    pass
...
class Jurisdiction218(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Jurisdiction219(Jurisdiction218):
    pass
...
class Signal(AdCPBaseModel):
    ...
    consent_basis: Annotated[list[ConsentBasi] | None, Field(min_length=1)] = None
    art9_basis: Art9Basis | None = None
