...
class VerifyAgent415(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class SignalRefs1(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    scope: Annotated[
...
class SignalRefs2(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    scope: Annotated[
...
class SignalRefs3(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    scope: Annotated[
...
class SignalRefs(RootModel[SignalRefs1 | SignalRefs2 | SignalRefs3]):
    root: Annotated[
        SignalRefs1 | SignalRefs2 | SignalRefs3,
        Field(
