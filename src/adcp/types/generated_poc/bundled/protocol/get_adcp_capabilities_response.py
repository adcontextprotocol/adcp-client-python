...
class Signals(AdCPBaseModel):
    ...
    features: Annotated[
        Features2 | None, Field(description='Optional signals features supported')
    ] = None
...
class Transport(AdCPBaseModel):
    ...
    type: Annotated[Type12, Field(description='Protocol transport type')]
...
class Endpoint(AdCPBaseModel):
    ...
    preferred: Annotated[
        Type12 | None, Field(description='Preferred transport when host supports multiple')
    ] = None
...
class Params6(AdCPBaseModel):
    ...
    vast_version: Annotated[VastVersion2 | None, Field(description='Required VAST version.')] = None
