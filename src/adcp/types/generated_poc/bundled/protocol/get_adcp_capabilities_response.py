...
class CallerEventType(AdCPBaseModel):
    pass
...
class Schedule(AdCPBaseModel):
    ...
    alignment: Annotated[
        Alignment,
        Field(
            description='Calendar used to establish exact period boundaries. The obligation echoes resolved timestamps and source timezone.',
...
class MediaBuy(AdCPBaseModel):
    ...
    reporting_delivery: Annotated[
        ...
        Field(
            description='Managed reporting status and durable delivery capability. Presence requires media_buy.reporting_delivery in experimental_features. This generalizes, but does not remove, the legacy reporting_delivery_methods/offline_delivery_protocols surface.',
