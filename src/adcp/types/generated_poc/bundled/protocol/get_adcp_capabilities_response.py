...
class Account(AdCPBaseModel):
    ...
    supported_billing: Annotated[
        list[SupportedBillingEnum] | None,
        Field(
...
class Transport(AdCPBaseModel):
    ...
    type: Annotated[Type21, Field(description='Protocol transport type')]
...
class Endpoint(AdCPBaseModel):
    ...
    preferred: Annotated[
        Type21 | None, Field(description='Preferred transport when host supports multiple')
    ] = None
