...
#   filename:  bundled/protocol/list_tasks_response.json
...
class DomainBreakdown(AdCPBaseModel):
    ...
    creative: Annotated[
        int | None, Field(description='Number of creative tasks in results', ge=0)
    ] = None
...
class ListTasksResponse(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
