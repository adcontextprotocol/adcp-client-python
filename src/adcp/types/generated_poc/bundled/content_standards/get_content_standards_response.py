...
#   filename:  bundled/content_standards/get_content_standards_response.json
...
class DeclaredBy(AdCPBaseModel):
    ...
    role: Annotated[Role84, Field(description="Role of the declaring party in the supply chain")]
...
class DeclaredBy78(DeclaredBy):
    pass


class VerificationItem78(VerificationItem):
    pass


class DeclaredBy79(DeclaredBy):
    pass


class VerificationItem79(VerificationItem):
    pass


class DeclaredBy80(DeclaredBy):
    pass


class VerificationItem80(VerificationItem):
    pass
...
class GetContentStandardsResponse4(AdCPBaseModel):
    errors: list[Error]
    context: Annotated[
        dict[str, Any] | None,
        Field(
...
class AssetAccess10(AdCPBaseModel):
...
class AssetAccess11(AdCPBaseModel):
...
class AssetAccess12(AdCPBaseModel):
    method: Literal["signed_url"] = "signed_url"


class AssetAccess(RootModel[AssetAccess10 | AssetAccess11 | AssetAccess12]):
    root: Annotated[
        AssetAccess10 | AssetAccess11 | AssetAccess12,
...
class Pas(AdCPBaseModel):
    ...
    assets: Annotated[
        list[Assets | Assets108 | Assets109 | Assets110],
        Field(
...
class Jurisdiction82(Jurisdiction):
    pass


class Disclosure78(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    required: Annotated[
    ...
    jurisdictions: Annotated[
        list[Jurisdiction82] | None,
        Field(description="Jurisdictions where disclosure obligations apply", min_length=1),
    ] = None


class Provenance78(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    digital_source_type: DigitalSourceType | None = None
...
class Jurisdiction83(Jurisdiction):
    pass


class Disclosure79(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    required: Annotated[
    ...
    jurisdictions: Annotated[
        list[Jurisdiction83] | None,
        Field(description="Jurisdictions where disclosure obligations apply", min_length=1),
    ] = None


class Provenance79(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    digital_source_type: DigitalSourceType | None = None
...
class Jurisdiction84(Jurisdiction):
    pass


class Disclosure80(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    required: Annotated[
    ...
    jurisdictions: Annotated[
        list[Jurisdiction84] | None,
        Field(description="Jurisdictions where disclosure obligations apply", min_length=1),
    ] = None


class Provenance80(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    digital_source_type: DigitalSourceType | None = None
...
class Jurisdiction85(Jurisdiction):
    pass


class Disclosure81(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    required: Annotated[
    ...
    jurisdictions: Annotated[
        list[Jurisdiction85] | None,
        Field(description="Jurisdictions where disclosure obligations apply", min_length=1),
    ] = None


class Provenance81(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    digital_source_type: DigitalSourceType | None = None
...
class FailItem(AdCPBaseModel):
    ...
    assets: Annotated[
        list[Assets111 | Assets112 | Assets113 | Assets114],
        Field(
            description="Artifact assets in document flow order - text blocks, images, video, audio",
            max_length=200,
        ),
...
class GetContentStandardsResponse3(AdCPBaseModel):
...
GetContentStandardsResponse = GetContentStandardsResponse3 | GetContentStandardsResponse4
