...
class DeclaredBy(AdCPBaseModel):
    ...
    role: Annotated[Role246, Field(description="Role of the declaring party in the supply chain")]
...
class Jurisdiction222(Jurisdiction):
    pass
...
class Jurisdiction223(Jurisdiction):
    pass
...
class Jurisdiction224(Jurisdiction):
    pass
...
class Assets312(AdCPBaseModel):
    ...
    transcript_source: Annotated[
        TranscriptSource19 | None, Field(description="How the transcript was generated")
    ] = None
    provenance: Annotated[
        Provenance211 | None,
        Field(
...
class Jurisdiction225(Jurisdiction):
    pass
...
class Pass5(AdCPBaseModel):
    ...
    assets: Annotated[
        list[Assets | Assets310 | Assets311 | Assets312],
        Field(
...
class Jurisdiction226(Jurisdiction):
    pass
...
class Jurisdiction227(Jurisdiction):
    pass
...
class Jurisdiction228(Jurisdiction):
    pass
...
class Jurisdiction229(Jurisdiction):
    pass
...
class Jurisdiction230(Jurisdiction):
    pass
...
class Fail5(AdCPBaseModel):
    ...
    assets: Annotated[
        list[Assets313 | Assets314 | Assets315 | Assets316],
        Field(
            description="Artifact assets in document flow order - text blocks, images, video, audio",
            max_length=200,
        ),
