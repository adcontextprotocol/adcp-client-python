...
class DeclaredBy(AdCPBaseModel):
    ...
    role: Annotated[Role48, Field(description="Role of the declaring party in the supply chain")]
...
class Artifact(AdCPBaseModel):
    ...
    assets: Annotated[
        list[Assets | Assets53 | Assets54 | Assets55],
        Field(
