...
#   filename:  bundled/content_standards/calibrate_content_request.json
...
class DeclaredBy(AdCPBaseModel):
    ...
    role: Annotated[Role4, Field(description='Role of the declaring party in the supply chain')]
...
class VerifyAgent3(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class VerifyAgent5(VerifyAgent3):
    pass
...
class VerifyAgent7(VerifyAgent3):
    pass
...
class VerifyAgent9(VerifyAgent3):
    pass
...
class VerifyAgent11(VerifyAgent3):
    pass
...
class AssetAccess4(AdCPBaseModel):
...
class AssetAccess5(AdCPBaseModel):
...
class AssetAccess6(AdCPBaseModel):
    method: Literal['signed_url'] = 'signed_url'


class AssetAccess(RootModel[AssetAccess4 | AssetAccess5 | AssetAccess6]):
    root: Annotated[
        AssetAccess4 | AssetAccess5 | AssetAccess6,
        Field(
...
class Assets9(AdCPBaseModel):
    ...
    transcript_source: Annotated[
        TranscriptSource3 | None, Field(description='How the transcript was generated')
    ] = None
    provenance: Annotated[
        Provenance4 | None,
        Field(
...
class Assets5(RootModel[Assets | Assets7 | Assets8 | Assets9]):
    root: Annotated[Assets | Assets7 | Assets8 | Assets9, Field(discriminator='type')]
    def __getattr__(self, name: str) -> Any:
        """Proxy attribute access to the wrapped type."""
        if name.startswith('_'):
            raise AttributeError(name)
...
class CalibrateContentRequest(AdCPBaseModel):
    ...
    artifact: Annotated[Artifact, Field(description='Artifact to evaluate', title='Artifact')]
