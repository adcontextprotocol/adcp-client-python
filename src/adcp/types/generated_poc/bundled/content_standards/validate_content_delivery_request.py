...
class DeclaredBy(AdCPBaseModel):
    ...
    role: Annotated[Role1300, Field(description='Role of the declaring party in the supply chain')]
...
class VerifyAgent2465(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class DeclaredBy1233(DeclaredBy):
    pass
...
class VerifyAgent2467(VerifyAgent2465):
    pass
...
class VerifyAgent2469(VerifyAgent2465):
    pass
...
class VerifyAgent2471(VerifyAgent2465):
    pass
...
class VerifyAgent2473(VerifyAgent2465):
    pass
...
class Jurisdiction1284(Jurisdiction):
    pass
