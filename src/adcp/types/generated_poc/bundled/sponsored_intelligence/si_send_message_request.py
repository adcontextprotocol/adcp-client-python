...
class VerifyAgent1593(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class Jurisdiction833(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class DeclaredBy800(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    agent_url: Annotated[
    ...
    role: Annotated[Role844, Field(description='Role of the declaring party.')]
...
class SponsoredContext(AdCPBaseModel):
    ...
    declared_by: Annotated[
        DeclaredBy800 | None, Field(description='Agent or service that attached the declaration.')
    ] = None
    ext: Annotated[
        dict[str, Any] | None,
        Field(
