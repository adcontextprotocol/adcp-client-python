...
class VerifyAgent1587(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class Jurisdiction827(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class DeclaredBy794(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    agent_url: Annotated[
    ...
    role: Annotated[Role838, Field(description='Role of the declaring party.')]
...
class SponsoredContext(AdCPBaseModel):
    ...
    declared_by: Annotated[
        DeclaredBy794 | None, Field(description='Agent or service that attached the declaration.')
    ] = None
    ext: Annotated[
        dict[str, Any] | None,
        Field(
