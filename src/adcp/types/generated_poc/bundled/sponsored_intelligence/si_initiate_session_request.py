...
class VerifyAgent1589(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class Jurisdiction829(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class DeclaredBy796(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    agent_url: Annotated[
    ...
    role: Annotated[Role840, Field(description='Role of the declaring party.')]
...
class SponsoredContext(AdCPBaseModel):
    ...
    declared_by: Annotated[
        DeclaredBy796 | None, Field(description='Agent or service that attached the declaration.')
    ] = None
    ext: Annotated[
        dict[str, Any] | None,
        Field(
...
class HostReceipt(AdCPBaseModel):
    ...
    accepted_context_use: SIContextUse | None = None
...
class SponsoredContextReceipt(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
