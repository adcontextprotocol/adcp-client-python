...
class VerifyAgent1595(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class Jurisdiction835(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class DeclaredBy802(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    agent_url: Annotated[
    ...
    role: Annotated[Role846, Field(description='Role of the declaring party.')]
...
class SponsoredContext(AdCPBaseModel):
    ...
    declared_by: Annotated[
        DeclaredBy802 | None, Field(description='Agent or service that attached the declaration.')
    ] = None
    ext: Annotated[
        dict[str, Any] | None,
        Field(
