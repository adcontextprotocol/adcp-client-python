...
#   filename:  bundled/creative/get_creative_delivery_request.json
...
class DataSubjectContestation17(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class VerifyAgent43(AdCPBaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    agent_url: Annotated[
...
class Brand(AdCPBaseModel):
    ...
    data_subject_contestation: Annotated[
        DataSubjectContestation | DataSubjectContestation17 | None,
        Field(
