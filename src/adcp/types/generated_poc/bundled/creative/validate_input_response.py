...
#   filename:  bundled/creative/validate_input_response.json
...
class ValidateInputResponse(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    ...
    results: Annotated[list[Result], Field(description='Per-target validation results.')]
