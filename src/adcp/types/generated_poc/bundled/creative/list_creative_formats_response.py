...
class Requirements2(AdCPBaseModel):
    ...
    formats: Annotated[list[Format18] | None, Field(description='Accepted audio file formats')] = (
        None
    )
...
class Dimensions9(Dimensions):
    pass


class Renders3(AdCPBaseModel):
    role: Annotated[
        str,
        Field(
            description="Semantic role of this rendered piece (e.g., 'primary', 'companion', 'mobile_variant')"
...
class Assets143(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets144(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets145(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets146(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets147(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets148(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets149(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets150(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
    asset_type: Literal['zip'] = 'zip'


class Assets151(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets152(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets153(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets154(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets155(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets156(BaseIndividualAsset):
    item_type: Literal['individual'] = 'individual'
...
class Assets159(BaseGroupAsset):
    asset_type: Literal['image'] = 'image'
    requirements: Annotated[
        Requirements13 | None,
        Field(
...
class Assets160(BaseGroupAsset):
    asset_type: Literal['video'] = 'video'
    requirements: Annotated[
        Requirements14 | None,
        Field(
...
class Assets161(BaseGroupAsset):
    asset_type: Literal['audio'] = 'audio'
    requirements: Annotated[
        Requirements15 | None,
        Field(
...
class Assets162(BaseGroupAsset):
    asset_type: Literal['text'] = 'text'
    requirements: Annotated[
        Requirements16 | None,
        Field(
...
class Assets163(BaseGroupAsset):
    asset_type: Literal['markdown'] = 'markdown'
    requirements: Annotated[
        Requirements17 | None,
        Field(
...
class Assets164(BaseGroupAsset):
    asset_type: Literal['html'] = 'html'
    requirements: Annotated[
        Requirements18 | None,
        Field(
...
class Assets165(BaseGroupAsset):
    asset_type: Literal['css'] = 'css'
    requirements: Annotated[
        Requirements19 | None,
        Field(description='Requirements for CSS creative assets.', title='CSS Asset Requirements'),
...
class Assets166(BaseGroupAsset):
    asset_type: Literal['javascript'] = 'javascript'
    requirements: Annotated[
        Requirements20 | None,
        Field(
...
class Assets167(BaseGroupAsset):
    asset_type: Literal['zip'] = 'zip'


class Assets168(BaseGroupAsset):
    asset_type: Literal['vast'] = 'vast'
    requirements: Annotated[
        Requirements21 | None,
        Field(
...
class Assets169(BaseGroupAsset):
    asset_type: Literal['daast'] = 'daast'
    requirements: Annotated[
        Requirements22 | None,
        Field(
...
class Assets170(BaseGroupAsset):
    asset_type: Literal['url'] = 'url'
    requirements: Annotated[
        Requirements23 | None,
        Field(
...
class Assets171(BaseGroupAsset):
    asset_type: Literal['webhook'] = 'webhook'
    requirements: Annotated[
        Requirements24 | None,
        Field(
...
class Assets157(AdCPBaseModel):
    ...
    assets: Annotated[
        list[Assets158], Field(description='Assets within each repetition of this group')
    ]
...
class Params17(AdCPBaseModel):
    ...
    audio_codecs: list[AudioCodec6] | None = None
    containers: list[Container4] | None = None
    ...
    asset_source: Annotated[
        AssetSource | None,
        Field(
            description='Where the rendered asset bytes come from. Single shared enum across canonicals. See `image.json#asset_source` for the full semantics. `publisher_host_recorded` is audio-specific and has no defined behavior on video — adopters MUST select a value appropriate to the canonical.'
        ),
    ] = AssetSource.buyer_uploaded
    buyer_asset_acceptance: Annotated[
        BuyerAssetAcceptance | None,
...
class Params19(AdCPBaseModel):
    ...
    duration_ms_range: Annotated[
        list[DurationMsRangeItem] | None,
        Field(
            description='[min, max] duration in milliseconds. **Precedence**: `duration_ms_exact` takes precedence when both ship on the same product. SDKs SHOULD lint a warning when both fields ship.',
            max_length=2,
            min_length=2,
        ),
    ] = None
    ...
    audio_codecs: list[AudioCodec7] | None = None
...
class Params22(AdCPBaseModel):
    ...
    image_formats: Annotated[
        list[ImageFormat4] | None, Field(description='Permitted image file formats.')
    ] = None
    ssl_required: Annotated[
        bool | None,
        Field(
    ...
    buyer_asset_acceptance: Annotated[
        BuyerAssetAcceptance | None,
        Field(
            description='Whether the product accepts buyer-uploaded native assets. When `rejected`, the buyer cannot ship pre-rendered title/image/body — they must use `build_creative` (or `sync_creatives` with brief inputs) so the seller produces the native bundle from a brief.'
        ),
    ] = BuyerAssetAcceptance.accepted
