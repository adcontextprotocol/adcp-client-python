...
#   timestamp: 2025-11-15T17:40:44+00:00
...
class CreativeAgent(AdCPBaseModel):
    ...
    agent_name: str | None = Field(None, description='Human-readable name for the creative agent')
    capabilities: list[Capability] | None = Field(
        None, description='Capabilities this creative agent provides'
    )
...
class ListCreativeFormatsResponseCreativeAgent(AdCPBaseModel):
    ...
    creative_agents: list[CreativeAgent] | None = Field(
        None,
