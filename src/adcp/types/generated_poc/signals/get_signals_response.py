...
from ..core import deployment, duration, error, pagination_response, vendor_pricing_option
...
class GetSignalsResponse(AdcpVersionEnvelope, ProtocolEnvelope):
    ...
    signals: Annotated[Sequence[Signal] | None, Field(description="Array of matching signals")] = (
        None
    )
    errors: Annotated[
