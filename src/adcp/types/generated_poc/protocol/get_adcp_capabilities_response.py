...
from ..core import account_timezone_capability, attestation_capabilities
...
class Transport(AdCPBaseModel):
    ...
    type: Annotated[Type5, Field(description='Protocol transport type')]
...
class Endpoint(AdCPBaseModel):
    ...
    preferred: Annotated[
        Type5 | None, Field(description='Preferred transport when host supports multiple')
    ] = None
