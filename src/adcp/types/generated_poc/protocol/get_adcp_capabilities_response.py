...
class ContentStandardsDetail(AdCPBaseModel):
...
class TrustedMatch(AdCPBaseModel):
    supported: Annotated[
        bool | None, Field(description='Whether this seller has TMP infrastructure deployed.')
    ] = False
    surfaces: Annotated[
...
class MediaBuy(AdCPBaseModel):
    ...
    content_standards_detail: Annotated[
        ContentStandardsDetail | None,
        Field(
