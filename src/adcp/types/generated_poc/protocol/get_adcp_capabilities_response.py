...
class AccountResolution(Enum):
    explicit_account_id = 'explicit_account_id'
    implicit_from_sync = 'implicit_from_sync'
...
class SupportedHashedIdentifier(Enum):
    hashed_email = 'hashed_email'
    hashed_phone = 'hashed_phone'
...
class Targeting(AdCPBaseModel):
    ...
    keyword_targets: Annotated[
        bool | None,
        Field(
            description='Whether seller supports keyword targeting via targeting_overlay.keyword_targets and keyword_targets_add/remove in update_media_buy'
        ),
    ] = None
    language: Annotated[
        bool | None,
...
class AudienceTargeting(AdCPBaseModel):
    ...
    supported_identifier_types: Annotated[
        ...
        Field(
            description='Identifier types accepted for audience matching. Buyers should only send identifiers the seller supports.',
            min_length=1,
        ),
    ]
...
class ConversionTracking(AdCPBaseModel):
    ...
    supported_hashed_identifiers: Annotated[
        list[SupportedHashedIdentifier] | None,
        Field(
