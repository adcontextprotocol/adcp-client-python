...
Generation date: 2026-02-18 17:56:28 UTC
"""
...
# Backwards-compat type: brand-manifest.json was removed from upstream in latest schemas.
# BrandManifest is kept as a permissive model so existing code importing it continues to work.
