...
def test_registry_has_literal_entries_plus_seven_structural_fallbacks() -> None:
    """3.1.8 ships literal mappings plus 7 structural fallback entries.
    ...
    assert len(registry.mappings) == 29
    assert len(literal) == 22
